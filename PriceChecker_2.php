...
if ($row_ct_2 > 0)
{
    ...
    echo "<div class='text-center'><a href='http://accountcreationseanmcdowell.great-site.net/PriceChecker_1.html'><button>Homepage</button></a></div>"; 
